...
class Car(ABC):  # Am definit clasa Car care mosteneste conceptul de abstractizare
    # (fara mostenirea asta nu o putem face abstracta)
    ...
    @classmethod
    def stop(cls):  # O clasa abstracta poate sa contina si metode normale (care au logica interna)
...
class Ferrari(Car):
    def accelerate(self):  # daca nu am avea metoda asta definita, am primi o exceptie de tip NotImplementedError
        print("I'm accelerating from 0 to 100 in 5 seconds")  # puteti sa incercati
        # sa o comentati sa vedeti ce se intampla

    def stop(self):
        print("I'm a F, I can't stop")


# Am implementat din nou o clasa care mosteneste clasa abstracta Car.
# Aici de asemenea suntem obligati sa implementam metoda accelerate
...
# Mai jos am definit o Interfata - adica o clasa abstracta in care toate metodele sunt abstracte
